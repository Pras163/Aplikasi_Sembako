 ...
 * @author TOSHIBA DC
 */
public class popup_suplier extends javax.swing.JDialog {
Connection conn;
    Statement st;
    ResultSet rs;
     ...
     */
    public popup_suplier(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
public void tampil(){
        Object header[]={"id_suplier","nama_suplier","email_suplier","no_telpon","alamat"};
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED, new java.awt.Color(102, 204, 255), new java.awt.Color(102, 204, 255), new java.awt.Color(102, 204, 255), new java.awt.Color(102, 204, 255)), "Table Data Suplier", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 14), new java.awt.Color(102, 204, 255))); // NOI18N
        ...
        jPanel1.add(txtcari, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 30, 170, 30));
        ...
        tabelsuplier.setIntercellSpacing(new java.awt.Dimension(0, 0));
    ...
    private void tabelsuplierMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelsuplierMouseClicked
        // TODO add your handling code here:
        int barang = tabelsuplier.getSelectedRow();
        fAB.Kosupp =tabelsuplier.getValueAt(barang,0).toString();
          fAB.Namsupp =tabelsuplier.getValueAt(barang,1).toString();
    ...
    private void cariBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cariBTActionPerformed
        ...
        tabelsuplier.setModel(data);
        setKoneksi();
        String sql="Select * from barang where kode_barang like '%" + txtcari.getText() + "%'" + "or nm_barang like '%" + txtcari.getText()+ "%'";
        try {
            ResultSet rs=st.executeQuery(sql);
            while (rs.next())
            {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(popup_suplier.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                popup_suplier dialog = new popup_suplier(new javax.swing.JFrame(), true);
